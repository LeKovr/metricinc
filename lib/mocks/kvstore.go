...
// Source: github.com/LeKovr/metricinc/lib/iface/kvstore (interfaces: Store)
...
func (m *MockStore) SetNumber(arg0 *int64) error {
	ret := m.ctrl.Call(m, "SetNumber", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetNumber indicates an expected call of SetNumber
func (mr *MockStoreMockRecorder) SetNumber(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetNumber", reflect.TypeOf((*MockStore)(nil).SetNumber), arg0)
}

// SetSettings mocks base method
func (m *MockStore) SetSettings(arg0 *setup.Settings) error {
	ret := m.ctrl.Call(m, "SetSettings", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetSettings indicates an expected call of SetSettings
func (mr *MockStoreMockRecorder) SetSettings(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetSettings", reflect.TypeOf((*MockStore)(nil).SetSettings), arg0)
}
